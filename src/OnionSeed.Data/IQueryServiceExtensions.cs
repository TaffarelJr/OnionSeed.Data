...
namespace OnionSeed.Data
{
	...
	{
		/// <summary>
		/// Wraps the given <see cref="IQueryService{TEntity, TIdentity}"/> in a <see cref="QueryServiceExceptionHandlerDecorator{TEntity, TIdentity, TException}"/>.
		/// </summary>
		...
		/// <returns>A new <see cref="QueryServiceExceptionHandlerDecorator{TEntity, TIdentity, TException}"/> wrapping the given <see cref="IQueryService{TEntity, TIdentity}"/>.</returns>
		...
		{
			return new QueryServiceExceptionHandlerDecorator<TEntity, TIdentity, TException>(inner, handler);
		}
	}
}
