...
namespace OnionSeed.Data
{
	...
	public static class RepositoryExtensions
	{
		...
		/// <summary>
		/// Wraps the given <see cref="IRepository{TEntity, TIdentity}"/> in a <see cref="RepositoryTapDecorator{TEntity, TIdentity}"/>,
		...
		/// <returns>A new <see cref="RepositoryTapDecorator{TEntity, TIdentity}"/> wrapping the two given <see cref="IRepository{TEntity, TIdentity}"/> instances.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="inner"/> is <c>null</c>.
		...
		public static IRepository<TEntity, TIdentity> WithTap<TEntity, TIdentity>(this IRepository<TEntity, TIdentity> inner, IRepository<TEntity, TIdentity> tap)
			...
			where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
		{
			return new RepositoryTapDecorator<TEntity, TIdentity>(inner, tap);
		}
		...
		public static IRepository<TEntity, TIdentity> WithTap<TEntity, TIdentity>(this IRepository<TEntity, TIdentity> inner, IRepository<TEntity, TIdentity> tap, ILogger logger)
			...
			where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
		{
			return new RepositoryTapDecorator<TEntity, TIdentity>(inner, tap, logger);
		}
	}
}
