...
namespace OnionSeed.Data.Decorators
{
	...
	public class RepositoryExceptionHandlerDecorator<TEntity, TIdentity, TException> : RepositoryDecorator<TEntity, TIdentity>
		where TEntity : IEntity<TIdentity>
		where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
		where TException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="RepositoryExceptionHandlerDecorator{TEntity, TIdentity, TException}"/> class,
		...
		public RepositoryExceptionHandlerDecorator(IRepository<TEntity, TIdentity> inner, Func<TException, bool> handler)
			: base(inner)
		{
