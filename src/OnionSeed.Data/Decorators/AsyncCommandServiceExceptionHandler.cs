...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncCommandServiceExceptionHandler<TEntity, TIdentity, TException> : AsyncCommandServiceDecorator<TEntity, TIdentity>
		where TEntity : IAggregateRoot<TIdentity>
		where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
		where TException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncCommandServiceExceptionHandler{TEntity, TIdentity, TException}"/> class,
		...
		public AsyncCommandServiceExceptionHandler(IAsyncCommandService<TEntity, TIdentity> inner, Func<TException, bool> handler)
			: base(inner)
		{
