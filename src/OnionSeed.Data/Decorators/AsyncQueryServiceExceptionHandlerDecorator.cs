...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncQueryServiceExceptionHandlerDecorator<TEntity, TIdentity, TException> : AsyncQueryServiceDecorator<TEntity, TIdentity>
		where TEntity : IEntity<TIdentity>
		where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
		where TException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncQueryServiceExceptionHandlerDecorator{TEntity, TIdentity, TException}"/> class,
		...
		public AsyncQueryServiceExceptionHandlerDecorator(IAsyncQueryService<TEntity, TIdentity> inner, Func<TException, bool> handler)
			: base(inner)
		{
