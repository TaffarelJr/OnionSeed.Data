...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncRepositoryTapDecorator<TEntity, TIdentity> : AsyncRepositoryDecorator<TEntity, TIdentity>
		...
		where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
	{
		...
		/// </summary>
		/// <remarks>This behavior gives better performance, as both repositories are executing in parallel.
