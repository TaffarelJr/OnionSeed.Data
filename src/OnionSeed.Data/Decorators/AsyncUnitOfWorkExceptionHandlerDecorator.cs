...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncUnitOfWorkExceptionHandlerDecorator<TException> : AsyncUnitOfWorkDecorator
		where TException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncUnitOfWorkExceptionHandlerDecorator{TException}"/> class,
		...
		public AsyncUnitOfWorkExceptionHandlerDecorator(IAsyncUnitOfWork inner, Func<TException, bool> handler)
			: base(inner)
		{
