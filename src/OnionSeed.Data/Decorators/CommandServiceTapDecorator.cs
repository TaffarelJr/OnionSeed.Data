...
namespace OnionSeed.Data.Decorators
{
	...
	public class CommandServiceTapDecorator<TEntity, TIdentity> : CommandServiceDecorator<TEntity, TIdentity>
		where TEntity : IEntity<TIdentity>
		where TIdentity : IEquatable<TIdentity>, IComparable<TIdentity>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CommandServiceTapDecorator{TEntity,TKey}"/> class.
		/// </summary>
		...
		public CommandServiceTapDecorator(ICommandService<TEntity, TIdentity> inner, ICommandService<TEntity, TIdentity> tap)
			: this(inner, tap, null)
		{
		}
		...
		/// <exception cref="ArgumentNullException"><paramref name="inner"/> is <c>null</c>.
		/// -or- <paramref name="tap"/> is <c>null</c>.</exception>
		public CommandServiceTapDecorator(ICommandService<TEntity, TIdentity> inner, ICommandService<TEntity, TIdentity> tap, ILogger logger)
			: base(inner)
		{
