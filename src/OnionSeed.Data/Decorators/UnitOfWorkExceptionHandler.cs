...
namespace OnionSeed.Data.Decorators
{
	...
	public class UnitOfWorkExceptionHandler<TException> : UnitOfWorkDecorator
		where TException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="UnitOfWorkExceptionHandler{TException}"/> class,
		...
		public UnitOfWorkExceptionHandler(IUnitOfWork inner, Func<TException, bool> handler)
			: base(inner)
		{
