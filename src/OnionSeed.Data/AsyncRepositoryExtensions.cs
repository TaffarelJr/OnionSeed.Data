...
namespace OnionSeed.Data
{
	...
	{
		/// <summary>
		/// Wraps the given <see cref="IAsyncRepository{TEntity, TIdentity}"/> in a <see cref="AsyncRepositoryExceptionHandler{TEntity, TIdentity, TException}"/>.
		/// </summary>
		...
		/// <returns>A new <see cref="AsyncRepositoryExceptionHandler{TEntity, TIdentity, TException}"/> wrapping the given <see cref="IAsyncRepository{TEntity, TIdentity}"/>.</returns>
		...
		{
			return new AsyncRepositoryExceptionHandler<TEntity, TIdentity, TException>(inner, handler);
		}

		/// <summary>
		/// Wraps the given <see cref="IAsyncRepository{TEntity, TIdentity}"/> in a sequential <see cref="AsyncRepositoryTap{TEntity, TIdentity}"/>,
		...
		/// <returns>A new <see cref="AsyncRepositoryTap{TEntity, TIdentity}"/> wrapping the two given <see cref="IAsyncRepository{TEntity, TIdentity}"/> instances.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="inner"/> is <c>null</c>.
		...
		/// <summary>
		/// Wraps the given <see cref="IAsyncRepository{TEntity, TIdentity}"/> in a parallel <see cref="AsyncRepositoryTap{TEntity, TIdentity}"/>,
		/// mirroring all commands to the other given <see cref="IAsyncRepository{TEntity, TIdentity}"/>.
		/// </summary>
		/// <typeparam name="TEntity">The type of entities in the data store.</typeparam>
		/// <typeparam name="TIdentity">The type of the unique identity value of the entitites in the data store.</typeparam>
