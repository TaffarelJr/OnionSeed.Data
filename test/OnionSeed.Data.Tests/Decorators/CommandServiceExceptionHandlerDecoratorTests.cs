...
{
	public class CommandServiceExceptionHandlerDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new CommandServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(inner, handler);
		...
		public void Add_ShouldCallInner(bool handlerReturnValue)
		{
			...
			var subject = new CommandServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
