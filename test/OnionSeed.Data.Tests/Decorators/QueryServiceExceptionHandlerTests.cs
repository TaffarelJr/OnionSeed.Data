...
{
	public class QueryServiceExceptionHandlerTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new QueryServiceExceptionHandler<FakeEntity<int>, int, InvalidOperationException>(inner, handler);
		...
		public void GetCount_ShouldCallInner_AndReturnResult(bool handlerReturnValue)
		{
			...
			var subject = new QueryServiceExceptionHandler<FakeEntity<int>, int, InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
