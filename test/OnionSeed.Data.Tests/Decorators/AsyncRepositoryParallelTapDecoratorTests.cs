...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncRepositoryParallelTapDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeTap)
		{
			...
			// Act
			Action action = () => new AsyncRepositoryParallelTapDecorator<FakeEntity<int>, int>(inner, tap);
		...
		public async Task AddAsync_ShouldCallInner_AndTap()
		{
			...
			var subject = new AsyncRepositoryParallelTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object);
		...
		public async Task AddAsync_ShouldCallInner_AndTap_WhenLoggerIsGiven()
		{
			...
			var subject = new AsyncRepositoryParallelTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object, _mockLogger.Object);
