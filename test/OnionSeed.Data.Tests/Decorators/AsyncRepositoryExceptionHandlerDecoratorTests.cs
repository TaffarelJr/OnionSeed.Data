...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncRepositoryExceptionHandlerDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new AsyncRepositoryExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(inner, handler);
		...
		public async Task GetCountAsync_ShouldCallInner_AndReturnResult(bool handlerReturnValue)
		{
			...
			var subject = new AsyncRepositoryExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
