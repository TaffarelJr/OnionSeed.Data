...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncQueryServiceExceptionHandlerDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new AsyncQueryServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(inner, handler);
		...
		public async Task GetCountAsync_ShouldCallInner_AndReturnResult(bool handlerReturnValue)
		{
			...
			var subject = new AsyncQueryServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
