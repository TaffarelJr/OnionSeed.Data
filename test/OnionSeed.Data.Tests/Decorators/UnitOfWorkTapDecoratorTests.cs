...
{
	public class UnitOfWorkTapDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeTap)
		{
			...
			// Act
			Action action = () => new UnitOfWorkTapDecorator(inner, tap);
		...
		public void Commit_ShouldCallInner_AndTap()
		{
			...
			var subject = new UnitOfWorkTapDecorator(_mockInner.Object, _mockTap.Object);
		...
		public void Commit_ShouldCallInner_AndTap_WhenLoggerIsGiven()
		{
			...
			var subject = new UnitOfWorkTapDecorator(_mockInner.Object, _mockTap.Object, _mockLogger.Object);
