...
{
	public class CommandServiceTapDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeTap)
		{
			...
			// Act
			Action action = () => new CommandServiceTapDecorator<FakeEntity<int>, int>(inner, tap);
		...
		public void Add_ShouldCallInner_AndTap()
		{
			...
			var subject = new CommandServiceTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object);
		...
		public void Add_ShouldCallInner_AndTap_WhenLoggerIsGiven()
		{
			...
			var subject = new CommandServiceTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object, _mockLogger.Object);
