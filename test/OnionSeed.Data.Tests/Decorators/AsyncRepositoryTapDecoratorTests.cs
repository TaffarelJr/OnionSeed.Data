...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncRepositoryTapDecoratorTests
	{
		...
		public async Task AddAsync_ShouldCallInner_AndTap_WhenParallel()
		{
			...
			var subject = new AsyncRepositoryTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object, parallelMode: true);
		...
		public async Task AddAsync_ShouldCallInner_AndTap_WhenLoggerIsGiven_AndParallel()
		{
			...
			var subject = new AsyncRepositoryTapDecorator<FakeEntity<int>, int>(_mockInner.Object, _mockTap.Object, _mockLogger.Object, true);
