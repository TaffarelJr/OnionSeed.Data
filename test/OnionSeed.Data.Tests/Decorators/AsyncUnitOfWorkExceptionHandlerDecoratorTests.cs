...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncUnitOfWorkExceptionHandlerDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new AsyncUnitOfWorkExceptionHandlerDecorator<InvalidOperationException>(inner, handler);
		...
		public async Task CommitAsync_ShouldCallInner(bool handlerReturnValue)
		{
			...
			var subject = new AsyncUnitOfWorkExceptionHandlerDecorator<InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
