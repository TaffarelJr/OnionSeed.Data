...
namespace OnionSeed.Data.Decorators
{
	...
	public class AsyncCommandServiceExceptionHandlerDecoratorTests
	{
		...
		public void Constructor_ShouldValidateParameters(bool includeInner, bool includeHandler)
		{
			...
			// Act
			Action action = () => new AsyncCommandServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(inner, handler);
		...
		public async Task AddAsync_ShouldCallInner(bool handlerReturnValue)
		{
			...
			var subject = new AsyncCommandServiceExceptionHandlerDecorator<FakeEntity<int>, int, InvalidOperationException>(_mockInner.Object, ex =>
			{
				actualException = ex;
